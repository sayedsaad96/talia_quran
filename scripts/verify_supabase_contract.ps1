...
@{
  ...
  'pull_quran_bookmarks' = "SELECT pg_get_function_result('public.pull_quran_bookmarks()'::regprocedure) LIKE '%quran_bookmarks_cloud' AND has_function_privilege('authenticated','public.pull_quran_bookmarks()','EXECUTE')"
  ...
  'create_parent_reward' = "SELECT pg_get_function_result('public.create_parent_reward(uuid,text)'::regprocedure) LIKE '%parent_rewards' AND has_function_privilege('authenticated','public.create_parent_reward(uuid,text)','EXECUTE')"
  'unlock_parent_reward' = "SELECT pg_get_function_result('public.unlock_parent_reward(bigint)'::regprocedure) LIKE '%parent_rewards' AND has_function_privilege('authenticated','public.unlock_parent_reward(bigint)','EXECUTE')"
  'claim_parent_reward' = "SELECT pg_get_function_result('public.claim_parent_reward(bigint)'::regprocedure) LIKE '%parent_rewards' AND has_function_privilege('authenticated','public.claim_parent_reward(bigint)','EXECUTE')"
