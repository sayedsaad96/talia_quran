...
const tutorialGuideSections = [
  ...
  TutorialGuideSection(
    ...
    steps: [
      ...
      'بعد الإكمال يمكنك إعادة ضبط الجلسة أو العودة للرئيسية.',
    ],
    tips: [
  ...
  TutorialGuideSection(
    ...
    notes: [
      ...
      'الربط عن بعد يعتمد على الحساب/السحابة، بينما تقدم الطفل المحلي محفوظ في الجهاز.',
    ],
    whenUseful:
  ...
  TutorialGuideSection(
    ...
    whatItDoes:
        'تجمع الحساب والنسخ الاحتياطي، الملف الشخصي، وضع ولي الأمر، المظهر، اللغة، دقة التسميع، تذكيرات المراجعة والأذكار والدعاء، ومعلومات التطبيق.',
    howToOpen: 'اضغط الترس من الصفحة الرئيسية أو افتح مسار الإعدادات.',
    steps: [
      'سجّل الدخول أو أنشئ حسابًا بالبريد وكلمة المرور لحفظ تقدمك سحابيًا.',
  ...
  TutorialGuideSection(
    ...
    steps: [
      ...
      'سجّل الدخول عندما تريد مزامنة تقدم الحفظ والسلسلة و XP مع السحابة.',
    ],
    tips: [
      'افتح التطبيق بعد تغيير الجهاز أو إعادة التثبيت ثم سجّل الدخول لاسترجاع ما يدعمه الحساب.',
      'حافظ على اتصال جيد عند تشغيل الصوت أو المزامنة السحابية.',
    ],
    notes: [
