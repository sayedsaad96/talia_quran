...
class _KhatmahSetupPageState extends State<KhatmahSetupPage> {
  ...
  void _onCustomChanged(String value) {
    ...
    if (parsed != null && parsed > 0 && parsed <= KhatmahSchedulingEngine.totalPages) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final endDate = KhatmahSchedulingEngine.calculateEndDate(today, estimatedDays);
    final dateStr =
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: _presets.map((pages) {
                              final isSelected = _selectedPages == pages &&
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: isArabic ? 'أو عدد مخصص يومياً' : 'Or custom pages per day',
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              Text(
                                isArabic ? 'المدة التقديرية' : 'Estimated Duration',
                              ...
                              Text(
                                isArabic ? '$daysDisplay يوماً' : '$daysDisplay days',
                          ...
                          Column(
                            children: [
                              Text(
                                isArabic ? 'موعد الختام المتوقع' : 'Expected Completion',
                                style: AppTypography.bodySmall.copyWith(
                                  color: isDark
                                      ? AppColors.darkTextSecondary
                                      : AppColors.lightTextSecondary,
